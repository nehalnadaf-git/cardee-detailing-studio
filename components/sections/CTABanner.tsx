        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
              Open daily 9:30 AM – 8:00 PM. Bring your vehicle in and let our experts take care of the rest.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://maps.google.com/?q=CarDee+Detailing+Studio+Unkal+Cross+Hubballi"
                target="_blank"
          ...
          >
            <div className="relative rounded-2xl overflow-hidden sm:aspect-[4/5] lg:aspect-[3/4]">
              <img
                src="/assets/asset_8.webp"
                alt="CarDee Detailing Studio — Professional Car Care"
                loading="lazy"
                decoding="async"
                className="w-full sm:absolute sm:inset-0 sm:w-full sm:h-full object-cover"
              />
