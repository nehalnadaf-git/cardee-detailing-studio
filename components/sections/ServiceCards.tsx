...
const services = [
  {
    ...
    imageAlt: 'Interior car detailing at CarDee Hubli',
  ...
  },
  {
    ...
    imageAlt: 'Exterior car wash at CarDee Hubli',
  ...
  },
  {
    ...
    description:
      "Protect your car's paint with precision-applied PPF and ceramic coating — flawless finish, scratch resistance, and long-lasting protection against the elements.",
    tags: 'Ceramic Coating · PPF · Teflon Coating',
    image: '/service-images/3_ceramic_coating_ppf.webp',
    imageAlt: 'Ceramic coating and PPF at CarDee',
    modalService: 'Ceramic Coating',
  },
  {
    num: '[Service] [04]',
    category: 'Teflon Coating',
    title: 'Teflon Paint Protection',
    description:
      "A non-stick protective barrier applied to your car's paint surface — shields against UV rays, water spots, and minor abrasions for long-lasting gloss.",
    tags: 'Teflon · Paint Shield · UV Protection',
    image: '/service-images/4_teflon_paint_protection.webp',
    imageAlt: 'Teflon coating service at CarDee',
    modalService: 'Teflon Coating',
  },
  {
    num: '[Service] [05]',
  ...
  },
  {
    ...
    imageAlt: 'Premium car wash at CarDee Hubli',
    modalService: 'Exterior Wash & Polish',
  },
];
